...
class ImageController(private val imageService: ImageService) {
    @PostMapping("url")
    @Operation(summary = "Create an upload url based on the file name. Return the signed URL to use for uploading.")
    ...
    @Operation(summary = "Validate that the image is uploaded to the storage service and tag the image as validated.")
    ...
    @Operation(summary = "Delete the image based on the name.")
